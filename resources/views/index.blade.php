	...
	<main>
			...
			<div class="relative z-10 mx-auto grid max-w-7xl gap-12 px-6 pb-24 lg:grid-cols-2 lg:items-center lg:px-8 lg:pb-32">
				...
				<div class="relative mx-auto w-full max-w-sm">
					...
					<div class="absolute -bottom-6 -left-6 rounded-2xl bg-white p-4 shadow-soft">
						...
						<p class="text-[11px] font-semibold text-ink-400">5000+ jamaah terdaftar</p>
					</div>
				</div>
			</div>
		...
		<section class="mx-auto max-w-7xl px-6 py-20 lg:px-8" data-nav-theme="light">
			<div class="reveal mb-12 text-center">
				...
				<h2 class="mt-3 font-display text-3xl text-ink-900 sm:text-4xl">Momen Perjalanan Jamaah</h2>
			</div>
		...
		<section class="mx-auto max-w-7xl px-6 py-20 lg:px-8" data-nav-theme="light">
			...
			<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
				<article class="reveal group rounded-3xl border border-primary-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-soft">
					...
					<a href="{{ $instagram ?? 'https://instagram.com' }}" target="_blank" class="inline-block mt-4 rounded-full bg-linear-to-r from-[#f58529] via-[#dd2a7b] to-[#8134af] px-4 py-2 text-sm font-bold text-white transition-all duration-300 hover:scale-105 hover:shadow-lg">
				...
				<article class="reveal group rounded-3xl border border-primary-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-soft">
					...
					<a href="{{ $tiktok ?? 'https://tiktok.com' }}" target="_blank" class="inline-block mt-4 rounded-full bg-[#121212] px-4 py-2 text-sm font-bold text-white transition-all duration-300 hover:scale-105 hover:shadow-lg" style="box-shadow: -2px 0 0 #25F4EE, 2px 0 0 #FE2C55;">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="inline-block mb-1 me-1" viewBox="0 0 16 16">
				...
				<article class="reveal group rounded-3xl border border-primary-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-soft">
					...
					<a href="{{ $facebook ?? 'https://facebook.com' }}" target="_blank" class="inline-block mt-4 rounded-full bg-[#1877F2] px-4 py-2 text-sm font-bold text-white transition-all duration-300 hover:scale-105 hover:bg-[#166FE5] hover:shadow-lg">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="inline-block mb-1 me-1" viewBox="0 0 16 16">
...
@push('scripts')
    ...
    <script>
        (function() {
            ...
            let waNumber = "{{ \App\Helpers\PreferenceHelper::get('whatsapp_number', '6281283890098') }}".replace(/\D/g, "");
